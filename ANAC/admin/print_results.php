...
if ($code_type === 'IF') {
    ...
    // CORRECTION : Bien identifier théorie et pratique
...
<div class="wrap">
  ...
  <table class="main-table">
    ...
    <?php $rang = 1; foreach ($classement as $row):
      ...
      // CORRECTION : Bien attribuer théorie et pratique
      // $r = résultat de la session principale (celle qu'on imprime)
      // $rj = résultat de la session jumelle
      if ($se['type_session'] === 'theorique') {
          // On est sur la session théorie
          $r_theo = $r;
          $r_prat = $rj;
      } else {
          // On est sur la session pratique
          $r_theo = $rj;
          $r_prat = $r;
      }
      ...
      $moy_if    = null;
      if ($r_prat && $r_prat['moyenne_if'] !== null) {
          $moy_if = round((float)$r_prat['moyenne_if'],1);
      } elseif ($pct_theo !== null && $pct_prat !== null) {
          $moy_if = round(($pct_theo + $pct_prat) / 2, 1);
      }
